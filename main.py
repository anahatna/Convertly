...
import base64
import requests
from API import capture_camera, get_exchange_rates, convert_currency
...
# Add custom CSS to import Poppins font and apply it to the body
    ...
    st.markdown(
        ...
        unsafe_allow_html=True
    )   # Empty title to prevent double titles

    # Title and Slogan with Poppins Font
    st.markdown(
        "<h1 style='text-align: center; font-size:65px;'>Convertly</h1>", 
        unsafe_allow_html=True
